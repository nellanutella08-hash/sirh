...
// Mêmes 14 types que lib/db.ts (dupliqués ici, composant client),
// regroupés par nature plutôt qu'en une seule liste plate.
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              ...
              <div>
                ...
                <div className="flex max-h-48 flex-col gap-2 overflow-y-auto rounded-lg border border-v/15 bg-bg p-2">
